...
/*
The EventsRequestHandler is the HTTP handler that processes incoming HTTP requests that contain
the "/event" URL path. Returns ALL events for ALL family members of the current user. The current user is determined
            ...
            */
            if(exchange.getRequestMethod().toUpperCase().equals("GET")){
                ...
                if(reqHeaders.containsKey("Authorization")) {
                    ...
                    result = eventService.getAllEvents(request);//FIX ME
