...
/*
The EventRequestHandler is the HTTP handler that processes incoming HTTP requests that contain
the "/event/[eventID]" URL path. Returns the single Event object with the specified ID.
*/
public class EventRequestHandler implements HttpHandler {
    ...
    The EventRequestHandler is the HTTP handler that processes incoming HTTP request that contain
    the "/event/[eventID]" URL path.
    */
    @Override
            ...
            */
            if(exchange.getRequestMethod().toUpperCase().equals("GET")){
                ...
                if(reqHeaders.containsKey("Authorization")){
                    ...
                    //we create a new event service class object to pass the request object
                    ...
                    result = eventService.getSingleEvent(request);
